...
Class ("paella.videoFactories.MpegDashVideoFactory", {
	isStreamCompatible:function(streamData) {
		try {
			// #DCE override start (MATT-2205), disable this factory for iOS, mpeg dash does not on iOS
			// ref issue: https://github.com/polimediaupv/paella/issues/221
			...
			// #DCE override end (MATT-2205), only non-iOS can use this factory
		}
		catch (e) {}
		return false;
	},
