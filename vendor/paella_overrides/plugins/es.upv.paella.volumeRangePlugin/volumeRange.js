//#DCE TEMP pluing override for issue https://github.com/polimediaupv/paella/issues/219
Class ("paella.plugins.VolumeRangePlugin", paella.ButtonPlugin,{
	...
	updateClass: function() {
		...
		if (this._showMasterVolume && this._showSlaveVolume) {
			...
			if (this._showMasterVolume) {
				...
				volume = paella.player.videoContainer.masterVideo().volume().then(function(vol) {
				  This.setVolume(vol, This);
				});
			}
			if (this._showSlaveVolume) {
				//#DCE start temp override for https://github.com/polimediaupv/paella/issues/219
				volume = paella.player.videoContainer.slaveVideo().volume().then(function(vol) {
				  This.setVolume(vol, This);
				});
			}
		}
  ...
  setVolume: function(volume, This) {
	...
	//#DCE end fix for https://github.com/polimediaupv/paella/issues/219
